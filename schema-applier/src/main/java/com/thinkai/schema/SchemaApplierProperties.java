...
@ConfigurationProperties("thinkai.schema")
public class SchemaApplierProperties {
    private boolean enabled = true;
    private String resource = "/schema-definition.json";
    private String schema = "public";
    private String historyTable = "thinkai_schema_history";
    ...
    SchemaApplierOptions toOptions() {
        return new SchemaApplierOptions(schema, historyTable, advisoryLockId, dryRun, failOnPending,
                requireDefinition);
    }
}
